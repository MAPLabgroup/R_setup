...
# Installing the Rtools application externally is advised 
...
pkg.list = c('devtools', 'dplyr', 'ez', 'ggthemes', 'Hmisc', 
             'openxlsx', 'pkgbuild', 'psych', 'RColorBrewer', 
             'R.matlab', 'rprime', 'skimr', 'stringi', 'tidyr') 
